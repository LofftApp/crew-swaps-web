...
function LandingPage() {
  return (
    <div className="relative flex min-h-screen flex-col justify-between overflow-hidden">
      ...
      <div className="xs:p-8 xs:mt-2 flex flex-col items-center justify-center gap-4 p-12">
        ...
        <div className="ml-2 flex w-[90%] xs:w-[75%] items-center gap-2 rounded-full bg-base-300 p-2 text-sm justify-center">
          <div className="badge badge-primary text-sm font-semibold">
            Trusted
          </div>
          <p className=''>

            by the leading airlines ✨
            </p>
        </div>
