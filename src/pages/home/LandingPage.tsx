...
function LandingPage() {
  return (
    <div className="relative flex min-h-screen flex-col justify-between overflow-hidden">
      ...
      <div className="xs:p-8 xs:mt-2 flex flex-col items-center justify-center gap-4 p-12 md:gap-6 md:p-12 xl:gap-8 xl:p-20">
        ...
        <div className="xs:w-[80%] ml-2 flex w-[90%] items-center justify-center gap-2 rounded-full bg-base-300 p-2 text-sm sm:max-w-[50%] md:max-w-[55%] md:text-base lg:max-w-[35%] xl:max-w-[30%] xl:text-lg 2xl:text-xl">
