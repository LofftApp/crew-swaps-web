...
function RoundedLogo({ className }: { className?: string }) {
  return (
    <div className="flex transform flex-nowrap gap-2 px-4 py-4 text-xl font-bold text-base-content duration-200 ease-in-out hover:scale-105 md:text-2xl lg:gap-3 lg:text-2xl xl:text-3xl">
      <svg
